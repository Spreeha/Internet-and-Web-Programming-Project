...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	if($_POST['password']==$_POST['confirmpassword'])
	{
		...
		$result= "INSERT INTO candidate(username,email,password) VALUES('$username','$email','$password')";
if (mysqli_query($mysq, $result))
         {
        echo "New record successfully";
		echo $username;
		$_SESSION['message']="Registration Successful! Added $username to the database.";
		header("location: candidatelogin2.php");
         }
        else
         {
...
<div class="body-content">
  <div class="module">
    ...
    <form class="form" action="candidatereg.php" method="post" enctype="multipart/form-data" autocomplete="off">
