	...
	<br>
        ...
        <div class="info">
          <?php 
            ...
            echo "Welcome ".$var;
            $results = mysqli_query($con,"SELECT * FROM candidateprofile WHERE username='$var'");
            ...
            //$count = 'select * from candidateprofile where username='$var'';
            //echo " No of jobs applied for : ".$count;
          ?>
           <p> This the Online Job Portal! The one-stop destination for all your job needs!</p>
        </div>
      </div>
   </div>
     <div class="footer">
