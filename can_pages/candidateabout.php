            ...
            <div class="lg">
               ...
               <ul class="navs">   
                   ...
                   <li ><a  href="candidatehome.php">Home</a></li>
                    ...
                    <li><a  href="candidatejobsearch.php">Job Search</a></li>
					<li><a  href="#">My Candidate</a></li>
					<li><a  href="candidatejobs.php">My Jobs</a></li>
                          <!-- <li> <a href="#">Before you resign</a></li> -->
                    <li><a class="active" style="float:right" href="candidateabout.php">About us</a></li>
                    <li><a  style="float:right" href="candidatecontact.php">Contact us</a></li>
					<li><a href=""><img src="job3.jpg" width="50" height="50%">(<?php //echo $count + $countr + $countrs + $countrse ?>)</a>
					<ul>
					<li><a href="#">New Jobs (<?php//// echo $countr ?>)</a></li>
					<li><a href="#">Referalls referred (<?php //echo $count ?>)</a></li>
					<li><a href="#">Shortlisted referred candidates(<?php //echo $countrs ?>)</a></li>
					<li><a href="#">My shortlisted jobs (<?php //echo $countrse ?>)</a></li>
