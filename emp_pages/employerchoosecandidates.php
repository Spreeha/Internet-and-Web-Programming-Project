...
<br>
    ...
    <div class="content">
<center><h1> My Shortlisted Candidates </h1></center>
<hr>
</div>
        <div class="info">
          <br>
...
//$sql1 = "SELECT cname,title FROM job WHERE empuser='$var' ORDER BY date DESC ";  
  ...
  $results = mysqli_query($con,"SELECT canuser,resumeid,title,Status FROM applyresumetojobs WHERE Status=3 ");
...
<h1> Name:<a href="#"><?php echo $can; ?></a> </h1>
<hr>
        <div class="info">
<?php // echo $comp." ".$can; ?>
<center><p> Designation: <?php echo $title; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <!--Applying Date :--> <?php echo $date; ?>  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Candidate Resume ID: <?php echo $id; ?><br><br> <!--<a href="javascript:void(0)?;" onclick="theVar=confirm('Shortlist this candidate. Are you sure?');setTimeout('if(theVar){window.location=\'employershortcandidates.php?nam=<?php echo $can;?>\'}', 0);"> <input type = "submit" name="short" value="SHORTLIST THIS CANDIDATE" class="button"></a>
